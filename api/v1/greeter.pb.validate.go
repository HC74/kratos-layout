...
// Validate checks the field values on HelloReplyTest with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *HelloReplyTest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on HelloReplyTest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in HelloReplyTestMultiError,
// or nil if none found.
func (m *HelloReplyTest) ValidateAll() error {
	return m.validate(true)
}

func (m *HelloReplyTest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return HelloReplyTestMultiError(errors)
	}

	return nil
}

// HelloReplyTestMultiError is an error wrapping multiple validation errors
// returned by HelloReplyTest.ValidateAll() if the designated constraints
// aren't met.
type HelloReplyTestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m HelloReplyTestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m HelloReplyTestMultiError) AllErrors() []error { return m }

// HelloReplyTestValidationError is the validation error returned by
// HelloReplyTest.Validate if the designated constraints aren't met.
type HelloReplyTestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e HelloReplyTestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e HelloReplyTestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e HelloReplyTestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e HelloReplyTestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e HelloReplyTestValidationError) ErrorName() string { return "HelloReplyTestValidationError" }

// Error satisfies the builtin error interface
func (e HelloReplyTestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = HelloReplyTestValidationError{}
